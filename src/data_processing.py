...
class DataProcessor:
    def __init__(self, input_file, output_dir):
        ...
        logger.info("DataProcessor Class Started")
    ...
    def scale_ratings(self):
        try:
            ...
            logger.info("Data Scaling Process Finished")
        except Exception as e:
            raise CustomException("Failed to Perform Data Scaling", sys)
    ...
    def encode_data(self):
        try:
            ...
            logger.info("Successfully encoded Users and Anime Film")
        except Exception as e:
            raise CustomException("Failed to encode data for Users and Anime", sys)
    ...
    def split_data(self, test_size = 1000, random_state=43):
        try:
            ...
            ## There are two columns ["user", "anime"] and need to separate them
            self.X_train_array = [X_train[:, 0], X_train[:, 1]]
            self.X_test_array = [X_test[:, 0], X_test[:, 1]]
            self.y_train = y_train
            self.y_test = y_test

            logger.info("Data Split Process Successful")
    ...
    def save_artifacts(self):
        try:
            ...
            logger.info("Training, Testing, rating_df data saved successfully")
            #pass
        except Exception as e:
            raise CustomException("Failed to save data successfully.", sys)
    ...
    def process_data(self):
        try:
            ...
            #synopsis_df(SYNOPSIS_DF, index=False)## Error
            synopsis_df.to_csv(SYNOPSIS_DF, index=False)

            logger.info("DF, SYNOPSYS_DF saved successfully")
            #pass
        
        except Exception as e:
            raise CustomException("Failed to save anime.csv and anime_synopsis.csv", sys)
    ...
    #         #pass
    #     except Exception as e:
    #         raise CustomException("Failed to ", sys)
